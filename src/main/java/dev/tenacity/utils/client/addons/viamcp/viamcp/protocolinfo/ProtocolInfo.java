 ...
 */
package dev.tenacity.utils.client.addons.viamcp.viamcp.protocolinfo;
...
public class ProtocolInfo {
     ...
     * 获取当前玩家连接的协议处理链
     *
     * @param userConnection 当前玩家连接（Via 提供）
     * @return 协议链 ProtocolPipeline
     */
    public static ProtocolPipeline getPipeline(UserConnection userConnection) {
        return userConnection.getProtocolInfo().getPipeline();
    }
}
