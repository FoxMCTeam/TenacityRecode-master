package dev.tenacity.utils.client.addons.viamcp.gui;

import dev.tenacity.ui.mainmenu.CustomMainMenu;
import dev.tenacity.utils.client.addons.viamcp.ViaMCP;
import dev.tenacity.utils.client.addons.viamcp.protocols.ProtocolCollection;
...
public class GuiProtocolSelector extends GuiScreen {
    ...
    protected void actionPerformed(GuiButton guiButton) {
        ...
        if (guiButton.id == 1) {
            mc.displayGuiScreen(new GuiMultiplayer(new CustomMainMenu()));
        }
