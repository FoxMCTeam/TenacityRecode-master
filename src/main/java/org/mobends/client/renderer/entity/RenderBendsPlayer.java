package org.mobends.client.renderer.entity;

import lol.nightmaple.module.impl.render.MoBends;
...
import org.mobends.client.model.entity.ModelBendsPlayer;
import org.mobends.client.renderer.entity.layers.LayerBendsCape;
import org.mobends.client.renderer.entity.layers.LayerBendsCustomHead;
import org.mobends.client.renderer.entity.layers.LayerBendsPlayerArmor;
...
public class RenderBendsPlayer extends RenderPlayer {
    ...
    protected void preRenderCallback(AbstractClientPlayer p_77041_1_, float p_77041_2_) {
        ...
        if (MoBends.swordTrail.isEnabled()) {
            GL11.glPushMatrix();
            float f5 = 0.0625F;
