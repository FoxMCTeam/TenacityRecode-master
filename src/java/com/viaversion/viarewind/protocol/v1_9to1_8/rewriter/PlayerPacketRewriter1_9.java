        ...
        protocol.registerClientbound(ClientboundPackets1_9.PLAYER_POSITION, new PacketHandlers() {
            ...
            public void register() {
                ...
                handler(wrapper -> {
                    ...
                    PacketWrapper confirmTeleport = wrapper.create(ServerboundPackets1_9.ACCEPT_TELEPORTATION);
                    confirmTeleport.write(Types.VAR_INT, teleportId);
                    confirmTeleport.sendToServer(Protocol1_13To1_12_2.class);
