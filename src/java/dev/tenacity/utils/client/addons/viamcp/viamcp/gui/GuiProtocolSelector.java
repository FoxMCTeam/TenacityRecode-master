 ...
 */
package dev.tenacity.utils.client.addons.viamcp.viamcp.gui;

import com.viaversion.viaversion.api.protocol.version.ProtocolVersion;
import dev.tenacity.utils.client.addons.viamcp.vialoadingbase.ViaLoadingBase;
import dev.tenacity.utils.client.addons.viamcp.viamcp.protocolinfo.ProtocolInfo;
...
public class GuiProtocolSelector extends GuiScreen {
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        drawString(this.fontRendererObj, title, (int) ((width - (this.fontRendererObj.getStringWidth(title) * 2)) / 4), 5, -1);
