...
public class SplashScreen implements Utils {
    ...
    private static void drawScreen(float width, float height) {
        ...
        fr.drawCenteredString(Client.NAME, width / 2f, actualY,
        ...
        if (versionAnim != null) {
            ...
            float versionX = width / 2f + fr.getStringWidth(Client.NAME) / 2f - (versionWidth);
        ...
        if (progressAnim == null) {
            ...
            float rectWidth = fr.getStringWidth(Client.NAME) + 10;
            float rectHeight = 5;
            ...
            duckSansFont18.drawCenteredString("by " + Client.THANKS, width / 2f, actualY + 42, ColorUtil.applyOpacity(-1, textAlpha));
